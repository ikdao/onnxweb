...
ONNX Runtime Web is a Javascript library for running ONNX models on browsers and on JS/TS Runner.

ONNX Runtime Web has adopted WebAssembly, WebGL, WebGPU technologies for providing an optimized ONNX model inference runtime for both CPUs and GPUs.
...
ONNX Runtime Web currently support all operators in [ai.onnx](./docs/onnx-operators.md) and [ai.onnx.ml](https://github.com/onnx/onnx/blob/main/docs/Operators-ml.md).
